...
PROBLEM_DIR = str(Path(__file__).resolve().parent.parent / "problems" / "0070_climbing_stairs")


class TestClimbingStairsE2E(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_problem_meta_valid(self):
        self.assertEqual(self.meta["problem_id"], "0070_climbing_stairs")
        self.assertEqual(self.meta["entry"]["class_name"], "Solution")
        self.assertEqual(self.meta["entry"]["method_name"], "climbStairs")
    ...
    def test_visual_solution_trace_has_expected_events(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            case = load_cases(PROBLEM_DIR)[2]  # n=3, full DP loop
            ...
            self.assertIn("transition_considered", event_types)
...
class Solution:
    def climbStairs(self, n):
        return n  # always wrong — returns n instead of dp[n]
""")
